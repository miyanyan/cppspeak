      ...
      <nav className="sticky top-0 z-40 border-b border-white/5 bg-[#000205]/80 backdrop-blur-xl supports-[backdrop-filter]:bg-[#000205]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
             <a href="https://github.com/miyanyan/cppspeak" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-white transition-colors hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
