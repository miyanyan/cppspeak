...
export const CPP_TERMS: Term[] = [
  ...
  },
  {
    ...
    detailedExplanation: '元音发音类似 "Cup"，比较短促。美式发音中 u 发 /ʌ/。不要读成长音的 "Too"。',
  ...
  },
  {
    ...
    detailedExplanation: '关于 Char 的发音在英语世界也有争议 (Char/Care/Car)，但在 C++ 标准委员会和大多数正式场合，推荐读作 "Care" (Character 的词头) 或者 "Char" (烧焦)。这里的推荐发音 "Care" 是为了强调它是 Character 的缩写。',
